...
const OfferDetailsSegment = () => {
  ...
  const [contactName, setContactName] = useState("Dear Customer");
  ...
  const fetchOffers = async () => {
    ...
    try {
      ...
      if (res.status === "Success") {
        ...
        // console.log("Original Offers from API:", res.data.offers);
      ...
      {offers?.length > 0 && (
        <div className="flex flex-col items-center justify-center">
          ...
          <h3 className="mt-8 text-lg text-center">
            Congratulations{" "}
            <span className="text-2xl font-normal">{contactName} !!</span>{" "}
          </h3>
