...
import FormButtonStyleCheckOffer from "../../../../components/Form/FormButtonStyleCheckOffer";
...
const MobileOtpPage = ({
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      if (response.status === "Success") {
        setUserClickData({
          event_name: `otp-send-for-offer-check-v1`,
  ...
  const handleResendOtp = async () => {
    try {
      ...
      if (response.status === "Success") {
        setUserClickData({
          event_name: `resend-otp-form-for-offer-check-v1`,
          user_id: mobile || "unknown",
          affiliate_id: affId || "No Aff_id found",
        });
  ...
  const handleOtpSubmit = async () => {
    ...
    try {
      ...
      if (otpResponse.status === "Success") {
        setUserClickData({
          event_name: `verify-otp-offer-check-v1`,
          user_id: mobile || "unknown",
          affiliate_id: affId || "No Aff_id found",
        });
  ...
  return !isOtpGenerated ? (
    <div className="lead-capture-container1">
      {!isOtpGenerated ? (
        <>
          ...
          <FormButtonStyleCheckOffer
            style={{ backgroundColor: "#12F280" }}
            text="Get OTP"
