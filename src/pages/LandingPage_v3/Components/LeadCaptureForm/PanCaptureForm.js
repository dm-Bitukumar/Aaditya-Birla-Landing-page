      ...
      {!isOtpGenerated ? (
        <>
          ...
          <FormButtonStyle2
            ...
            id="btn-get-pan-otp-landing-v4"
            className="tracking-btn-get-pan-otp-landing-v4"
          />
        </>
      ) : (
        <>
          ...
          <FormButtonStyle2
            ...
            id="btn-verify-pan-otp-landing-v4"
            className="tracking-btn-verify-pan-otp-landing-v4"
          />
