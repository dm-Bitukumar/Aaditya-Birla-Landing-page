...
const EMICalculator = () => {
    ...
    const calculateTotalAmountPayable = (loanAmount, interestRate, loanTenure) => {
            ...
            <div className="container m-auto">
                ...
                <div className="row calculate">
                    <div className="col-md-6 col-12 left_part">
                        <div className="form">
                            <div className="row">
                                <label htmlFor="amount" className="col-12">Loan Amount</label>
                            </div>
                            <div className="row">
                            ...
                            <div className="row">
                                <label htmlFor="interest-rate" className="col-12">Rate of Interest (p.a.)</label>
                            </div>
                            <div className="row">
                                <div className="col-12">
                                    <div className="d-flex justify-content-end">
                            ...
                            <div className="row">
                                <label htmlFor="term" className="col-12">Loan Tenure</label>
                            </div>
                            <div className="row">
                                <div className="col-12">
                                    <div className="d-flex justify-content-end">
                        ...
                        <div className="card row">
                            <div className="col-sm-12 col-6 px-0 row up_part">
                                <div className="col-sm-6 col-12 px-0 total_payble">
                                    ...
                                    <p>₹ <span id="result3">{calculateTotalAmountPayable(loanAmount, interestRate, loanTenure)}</span></p>
                                </div>
                                <div className="col-sm-6 col-12 px-0 principle_amount">
                                    <p className="mb-1">Principle amount</p>
                                    <p>₹ <span id="result2">{convertNumberToIndianFormat(loanAmount)}</span></p>
                                </div>
                            </div>
                            <div className="col-sm-12 col-6 px-0 row down_part">
                                <div className="col-12 px-0 monthly_emi">
                                    <p>Monthly EMI</p>
                                    <p className={'my-3'}>₹ <span id="result1">{calculateMonthlyEMI(loanAmount, interestRate, loanTenure)}</span></p>
                                </div>
                            </div>
                        </div>
