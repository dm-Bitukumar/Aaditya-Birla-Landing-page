...
const WorkDetailsForm = ({ nextStep, previousStep }) => {
  ...
  const handleValidate = () => {
    ...
    } else if (_.isEmpty(work_pincode)) {
      isValid = false;
      setErrors("work_pincode");
      setErrorMessage("Please enter Work Pincode");
    } else if (work_pincode.length !== 6) {
      isValid = false;
      setErrors("work_pincode");
      setErrorMessage("Please enter valid Indian pincode");
    } else if (_.isEmpty(work_address1)) {
      isValid = false;
      setErrors("work_address1");
      setErrorMessage("Please enter Work Address Line 1");
    } else if (_.isEmpty(work_address2)) {
      isValid = false;
      setErrors("work_address2");
      setErrorMessage("Please enter Work Address Line 2");
