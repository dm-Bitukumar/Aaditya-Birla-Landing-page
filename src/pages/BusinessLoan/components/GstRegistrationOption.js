...
import {company_type_options, companyTypeOptionsMap} from "../../../constants/formData";
import FormMultiSelect from "../../../components/Form/FormMultiSelect";
import FormInput from "../../../components/Form/FormInput";
import FormSelect from "../../../components/Form/FormSelect";

const GstRegistrationOption = ({handleDataChange, data, errorMessage, errors}) => {
    return (
        <div>
            <div className={`input-group mb-3`}>
            <span className="input-group-text" style={{height: "58px"}}>
                <img src="/assets/icons/gst.png" alt={''} style={{height: '25px'}}/>
            </span>
                ...
                data.gst_available !== "" && (
                    data.gst_available === 'yes' ? (
                        ...
                        <div className={'my-3'}>
                            ...
                            />
                            <FormMultiSelect
                                options={data.company_type ? companyTypeOptionsMap[data.company_type] : []}
