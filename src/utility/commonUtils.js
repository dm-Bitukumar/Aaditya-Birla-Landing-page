...
export function getAllianceLeadFromMoneyTapInput(alliance_id, lead) {
  let alliance_lead = {};
  alliance_lead.contact_name = lead.name || lead.contact_name || `${lead.firstName || ""} ${lead.lastName || ""}`.trim();
  ...
  alliance_lead.profession_type = getProfessionTypeFromEntry(lead.profession || lead.professionType || "");
  alliance_lead.monthly_income = lead.monthly_income || lead.monthlyIncome || "";
