        ...
        <div className={'personal-loan-form'}>
            <img className="mb-1 mt-3 img logo-img" src="/assets/img/logo.png" alt=""/>
            {
                isOtpGenerated ? (
                    ...
                    <>
                        <img className="mb-3 my-5 img header-img" src="/assets/icons/header.png" alt=""/>
                        <h1 className="h3 mb-3 fw-normal text-center" style={{fontSize: "20px"}}>Unlock Your Pre-approved<br /><strong>Personal Loan Offer</strong></h1>
