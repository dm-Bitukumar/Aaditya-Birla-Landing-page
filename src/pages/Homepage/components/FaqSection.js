              ...
              <div className="col-12">
                <Accordion defaultActiveKey="0">
                  <Accordion.Item eventKey={"0"}>
                    ...
                    <Accordion.Body eventKey="0">Coming Soon...</Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey={"1"}>
                    <Accordion.Header>
                      What is Personal Loan and how it works?
                    </Accordion.Header>
                    <Accordion.Body eventKey="1">Coming Soon...</Accordion.Body>
                  </Accordion.Item>
                  <Accordion.Item eventKey={"2"}>
                    <Accordion.Header>
                      How do I know if I qualify for a loan with DigitMoney?
                    </Accordion.Header>
                    <Accordion.Body eventKey="2">Coming Soon...</Accordion.Body>
                  </Accordion.Item>
                </Accordion>
              </div>
            </div>
              ...
              <div className="col-12">
                <Accordion>
                  ...
                  <Accordion.Item eventKey={"3"}>
                    ...
                    <Accordion.Body eventKey="3">Coming Soon...</Accordion.Body>
                  </Accordion.Item>
                </Accordion>
              </div>
            </div>
